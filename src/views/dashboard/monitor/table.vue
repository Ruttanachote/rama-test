<template>
  <div>
    <div class="container justify-center items-center flex my-5">
      <n-card
        content-style="padding: 0;"
        title="ข้อมูลของฉัน"
        size="small"
        class="max-w-screen-lg bg-[#001527] text-white"
      >
        <div class="bg-white text-black p-5 ">
          <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-r-xl ">
              <thead
                class="text-xs text-gray-700 uppercase bg-blue-300 rounded-r-xl dark:bg-gray-700 dark:text-gray-400"
              >
                <tr>
    ...
    <div class="container justify-center items-center flex my-5">
      <n-card
        content-style="padding: 0;"
        title="หมวดหมูโปรโมชั่นที่สนใจ"
        size="small"
        class="max-w-screen-lg bg-[#001527] text-white"
      >
        <div class="bg-white text-black p-5 justify-center items-center flex">
          ไม่พบข้อมูล
        </div>
      </n-card>
    </div>
